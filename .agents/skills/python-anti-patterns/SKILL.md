...
description: >-
  Use this skill when reviewing Python code for common anti-patterns to avoid.
  Use as a checklist when reviewing code, before finalizing implementations, or
  when debugging issues that might stem from known bad practices.
modeSlugs:
  - sisyphus-code-validator-agent
  - sisyphus-debug-agent
  - sisyphus-python-coder-agent
  - sisyphus-planner-agent
---
